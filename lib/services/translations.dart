class AppTranslations {
  static const Map<String, Map<String, String>> translations = {
    'en': {
      ...
      'Log out from this device': 'Log out from this device',
      'Male': 'Male',
      ...
      'Clients exported successfully': 'Clients exported successfully',
      'Import completed: {imported} imported, {skipped} skipped.':
          'Import completed: {imported} imported, {skipped} skipped.',
      'Import completed, but no new clients were returned.':
          'Import completed, but no new clients were returned.',
      'Failed to export clients: {error}': 'Failed to export clients: {error}',
      'Salon': 'Salon',
      ...
      'Address already exists and cannot be updated.':
          'Address already exists and cannot be updated.',
      ...
      'Where would you like to log out?': 'Where would you like to log out?',
    ...
    'hi': {
      ...
      'Log out from all devices': 'सभी डिवाइस से लॉग आउट करें',
      'Log out from this device': 'इस डिवाइस से लॉग आउट करें',
      'Male': 'पुरुष',
      ...
      'Not happy': 'खुश नहीं',
      'Could be better': 'और बेहतर हो सकता था',
      'Okay': 'ठीक है',
      'Good': 'अच्छा',
      ...
      'Import': 'इम्पोर्ट',
      'Export': 'एक्सपोर्ट',
      'Export cancelled': 'एक्सपोर्ट रद्द किया गया',
      'Clients exported successfully': 'क्लाइंट सफलतापूर्वक एक्सपोर्ट किए गए',
      'Import completed: {imported} imported, {skipped} skipped.':
          'इम्पोर्ट पूरा हुआ: {imported} आयात हुए, {skipped} छोड़े गए।',
      'Import completed, but no new clients were returned.':
          'इम्पोर्ट पूरा हुआ, लेकिन कोई नया क्लाइंट वापस नहीं आया।',
      'Failed to export clients: {error}':
          'क्लाइंट एक्सपोर्ट करने में विफल: {error}',
      'Salon': 'सैलून',
      ...
      'Email us for help': 'मदद के लिए हमें ईमेल करें',
      'Unable to open email app': 'ईमेल ऐप नहीं खुल सका',
      ...
      'View Address': 'पता देखें',
      'Address added': 'पता जोड़ा गया',
      'Address already exists and cannot be updated.':
          'पता पहले से मौजूद है और अपडेट नहीं किया जा सकता।',
      'Unable to update address': 'पता अपडेट नहीं हो सका',
      ...
      'Where would you like to log out?': 'आप कहाँ से लॉग आउट करना चाहते हैं?',
      ...
      "A future date schedules this as an upcoming change. A past or today's date replaces the current arrangement.":
          'भविष्य की तारीख इसे आगामी बदलाव के रूप में शेड्यूल करती है। पिछली या आज की तारीख मौजूदा व्यवस्था को बदल देती है।',
      'ACTIONS': 'कार्रवाइयाँ',
      'Account deleted successfully': 'खाता सफलतापूर्वक हटाया गया',
      'Add Compensation': 'मुआवज़ा जोड़ें',
      'Address is missing: {fields}': 'पता अधूरा है: {fields}',
      'Address line 1': 'पता पंक्ति 1',
      'All Branches': 'सभी शाखाएँ',
      'Allow customers to book {name} online':
          'ग्राहकों को {name} ऑनलाइन बुक करने दें',
      'Assign Branch': 'शाखा असाइन करें',
      'Assign Role(s)': 'भूमिका(एँ) असाइन करें',
      'Assign Services': 'सेवाएँ असाइन करें',
      'Assign branch, roles, services and working hours.':
          'शाखा, भूमिकाएँ, सेवाएँ और कार्य समय असाइन करें।',
      'Bio': 'बायो',
      'Bio is required': 'बायो आवश्यक है',
      'Branch Setup': 'शाखा सेटअप',
      'Branch Working Hours': 'शाखा कार्य समय',
      'Branch can\'t be changed while editing. Use "Assign User" to add this member to a different branch.':
          'संपादन के दौरान शाखा नहीं बदली जा सकती। इस सदस्य को दूसरी शाखा में जोड़ने के लिए "Assign User" का उपयोग करें।',
      'Branch hours will be applied to all days.':
          'शाखा का समय सभी दिनों पर लागू होगा।',
      'Branch setup saved': 'शाखा सेटअप सहेजा गया',
      'Branch timings selected': 'शाखा समय चुना गया',
      'Cancel scheduled change?': 'शेड्यूल किया गया बदलाव रद्द करें?',
      'Career start date': 'करियर शुरू होने की तारीख',
      'Career start date is required': 'करियर शुरू होने की तारीख आवश्यक है',
      'Change Workspace': 'कार्यस्थान बदलें',
      'City or Village': 'शहर या गाँव',
      'Commission percentage must be 1 to 99':
          'कमीशन प्रतिशत 1 से 99 के बीच होना चाहिए',
      'Compensation': 'मुआवज़ा',
      'Compensation saved': 'मुआवज़ा सहेजा गया',
      'Conflicting branch': 'टकराव वाली शाखा',
      'Contract': 'कॉन्ट्रैक्ट',
      'Current compensation': 'वर्तमान मुआवज़ा',
      'Custom Working Hours': 'कस्टम कार्य समय',
      'Custom schedule': 'कस्टम शेड्यूल',
      'Edit Compensation': 'मुआवज़ा संपादित करें',
      'Edit the selected schedule to avoid overlap.':
          'ओवरलैप से बचने के लिए चुने गए शेड्यूल को संपादित करें।',
      'Effective date is required': 'प्रभावी तारीख आवश्यक है',
      'Email verification (member must verify)':
          'ईमेल सत्यापन (सदस्य को सत्यापित करना होगा)',
      'Employment Details': 'रोज़गार विवरण',
      'Employment Type': 'रोज़गार प्रकार',
      'Employment details saved': 'रोज़गार विवरण सहेजा गया',
      'Employment type': 'रोज़गार प्रकार',
      'Employment type updated': 'रोज़गार प्रकार अपडेट किया गया',
      'Enter a valid amount': 'मान्य राशि दर्ज करें',
      'Face Setup Images': 'फेस सेटअप इमेज',
      'Failed to load services. Please try again.':
          'सेवाएँ लोड नहीं हो सकीं। कृपया फिर से प्रयास करें।',
      'Finalize employment and compensation.': 'रोज़गार और मुआवज़ा अंतिम करें।',
      'First name is required': 'पहला नाम आवश्यक है',
      ...
      'History': 'इतिहास',
      'Invite others to Glowante': 'दूसरों को Glowante पर आमंत्रित करें',
      'Joined': 'जुड़े',
      'Keep branch timings': 'शाखा समय रखें',
      'Loading roles...please wait':
          'भूमिकाएँ लोड हो रही हैं... कृपया प्रतीक्षा करें',
      'Locked': 'लॉक्ड',
      'Logged out successfully': 'सफलतापूर्वक लॉग आउट किया गया',
      'MEMBER': 'सदस्य',
      'Marked Today': 'आज मार्क किया गया',
      'Monthly Base Amount': 'मासिक बेस राशि',
      'Monthly Salary': 'मासिक वेतन',
      'No compensation on file': 'कोई मुआवज़ा दर्ज नहीं है',
      'No roles available': 'कोई भूमिका उपलब्ध नहीं है',
      'No specialities available': 'कोई विशेषज्ञता उपलब्ध नहीं है',
      'No weekly schedule found': 'कोई साप्ताहिक शेड्यूल नहीं मिला',
      'Not Marked Yet': 'अभी मार्क नहीं किया गया',
      'Not set': 'सेट नहीं है',
      'Nothing new to save': 'सहेजने के लिए कुछ नया नहीं है',
      'ONLINE BOOKING': 'ऑनलाइन बुकिंग',
      'OTP sent successfully': 'OTP सफलतापूर्वक भेजा गया',
      'OTP verified successfully': 'OTP सफलतापूर्वक सत्यापित हुआ',
      'Online Booking': 'ऑनलाइन बुकिंग',
      'Open': 'खोलें',
      'Open custom working hours setup': 'कस्टम कार्य समय सेटअप खोलें',
      'Open days': 'खुले दिन',
      'Part Time': 'पार्ट टाइम',
      'Part-time': 'पार्ट-टाइम',
      'Past': 'पिछला',
      'Pay Type': 'भुगतान प्रकार',
      'Phone verification (member must verify)':
          'फोन सत्यापन (सदस्य को सत्यापित करना होगा)',
      'Photo added': 'फोटो जोड़ी गई',
      'Photo updated': 'फोटो अपडेट की गई',
      'Postal code': 'पिन कोड',
      'Predefined services': 'पूर्वनिर्धारित सेवाएँ',
      'Profile updated': 'प्रोफ़ाइल अपडेट हुई',
      'ROLES': 'भूमिकाएँ',
      'Record a Change': 'बदलाव दर्ज करें',
      'Record a new compensation arrangement below.':
          'नीचे नई मुआवज़ा व्यवस्था दर्ज करें।',
      'Record a new compensation arrangement for {name}.':
          '{name} के लिए नई मुआवज़ा व्यवस्था दर्ज करें।',
      'Reset Setup': 'सेटअप रीसेट करें',
      'Save & Continue': 'सहेजें और जारी रखें',
      'Schedule conflict': 'शेड्यूल टकराव',
      'Scheduled change cancelled': 'शेड्यूल किया गया बदलाव रद्द किया गया',
      'Select Specialities': 'विशेषज्ञताएँ चुनें',
      'Select a branch first': 'पहले शाखा चुनें',
      'Select at least one role': 'कम से कम एक भूमिका चुनें',
      'Select at least one speciality': 'कम से कम एक विशेषज्ञता चुनें',
      'Select branch': 'शाखा चुनें',
      'Select roles': 'भूमिकाएँ चुनें',
      'Select services before setting working hours':
          'कार्य समय सेट करने से पहले सेवाएँ चुनें',
      'Select services for this branch assignment.':
          'इस शाखा असाइनमेंट के लिए सेवाएँ चुनें।',
      'Select specialities': 'विशेषज्ञताएँ चुनें',
      'Select the branch where you want to edit':
          'वह शाखा चुनें जहाँ आप संपादन करना चाहते हैं',
      'Selected day': 'चुना गया दिन',
      'Set working hours': 'कार्य समय सेट करें',
      'Share App': 'ऐप शेयर करें',
      'Skip for now': 'अभी छोड़ें',
      "Skip the queue — book your salon's services via Glowante!":
          'लाइन छोड़ें — Glowante से अपने सैलून की सेवाएँ बुक करें!',
      'Specialities': 'विशेषज्ञताएँ',
      'Still needed for Active status': 'Active स्थिति के लिए अभी भी आवश्यक',
      'Stored Images': 'सहेजी गई इमेज',
      'Switch between Owner and Stylist': 'Owner और Stylist के बीच स्विच करें',
      'Switch between available roles': 'उपलब्ध भूमिकाओं के बीच स्विच करें',
      'Tap to add a photo': 'फोटो जोड़ने के लिए टैप करें',
      'Tell clients a bit about this member':
          'ग्राहकों को इस सदस्य के बारे में थोड़ा बताएं',
      'This booking cannot be started yet':
          'यह बुकिंग अभी शुरू नहीं की जा सकती',
      "This branch's working hours, applied to all days.":
          'इस शाखा का कार्य समय, सभी दिनों पर लागू।',
      'This member is already assigned to every branch in this salon.':
          'यह सदस्य इस सैलून की हर शाखा में पहले से असाइन है।',
      'This removes the upcoming compensation change. The current arrangement stays in effect.':
          'यह आगामी मुआवज़ा बदलाव हटाता है। मौजूदा व्यवस्था लागू रहेगी।',
      'This team member already has an active assignment during these times:':
          'इस टीम सदस्य के पास इन समयों में पहले से सक्रिय असाइनमेंट है:',
      'This team member is already assigned to another active branch at these times.':
          'यह टीम सदस्य इन समयों में दूसरी सक्रिय शाखा में पहले से असाइन है।',
      'Unable to upload photo': 'फोटो अपलोड नहीं हो सकी',
      'Unverified': 'सत्यापित नहीं',
      'Upcoming compensation': 'आगामी मुआवज़ा',
      'Update Compensation': 'मुआवज़ा अपडेट करें',
      'Update Now': 'अभी अपडेट करें',
      'Update Required': 'अपडेट आवश्यक है',
      'Use branch working hours for all days':
          'सभी दिनों के लिए शाखा कार्य समय उपयोग करें',
      'View Services': 'सेवाएँ देखें',
      'Weekly configured hours for this branch':
          'इस शाखा के लिए साप्ताहिक सेट किए गए घंटे',
      'Welcome back': 'वापसी पर स्वागत है',
      'Working Schedule': 'कार्य शेड्यूल',
      'You can select up to 10 specialities':
          'आप अधिकतम 10 विशेषज्ञताएँ चुन सकते हैं',
      "You're adding": 'आप जोड़ रहे हैं',
      '{from} to {to}': '{from} से {to}',
      '{n} Working Day': '{n} कार्य दिवस',
      '{n} Working Days': '{n} कार्य दिवस',
      '{n} selected': '{n} चयनित',
      '{n} services selected': '{n} सेवाएँ चयनित',
      '{n} years of experience': '{n} वर्षों का अनुभव',
    },
  };
