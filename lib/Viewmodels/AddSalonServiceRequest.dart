...
class AddSalonServiceRequest {
  ...
  final int? branchSubCategoryId;    // Optional — use when attaching under a subcategory
  ...
  Map<String, dynamic> toJson() {
    ...
    if (branchCategoryId != null && branchSubCategoryId != null) {
      throw Exception("Only one of branchCategoryId or branchSubCategoryId should be provided.");
    }
